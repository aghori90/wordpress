      ...
      <section class="wrapper banner-wrapper">
         <div id="flexSlider" class="flexslider">
            ...
            <li><img id="banner1" src="<?php echo get_template_directory_uri(); ?>/theme/images/banner/slider-1.jpg" alt="Banner Image 1" title="Banner 1"></li>
               ...
               <li> <img src="<?php echo get_template_directory_uri(); ?>/theme/images/banner/slider-5.jpg" alt="Banner Image 5" title="Banner 5"></li>
               <li> <img src="<?php echo get_template_directory_uri(); ?>/theme/images/banner/slider-6.jpg" alt="Banner Image 6" title="Banner 6"></li>
...
<?php foreach ($categories as $c) { ?>
                           <div class="clearfix" id="hor_1_tab_item-0">
                              <div class="col-3">                                                               
                                 <ul>
<?php 
   query_posts('cat='.$c->term_id.'&showposts=-1');
   while (have_posts()) : the_post();
?>
                                    <li> 
                                       <a href="<?php the_content(); ?>" target="_blank" title="A pdf file">
                                          <?php the_title(); ?>
